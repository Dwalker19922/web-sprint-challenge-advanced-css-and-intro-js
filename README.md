...
accessibility is the access to those who have disabilities, an acessible site has proper resonsivness  and has symantic html to allow for speach reader capability
2. Talk about 3 different things you can do to ensure your website is accessible. 
 easy to read text,resposive layout,symantic tags
3. How would you explain the concept of a variable to someone new to programming?
variables are a set value that can be redeclared
4. What is the purpose of using functions in code?
adds functionality to your website
