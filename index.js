...
function changename(){
if(artists[8].name= "Vincent van Dough") {
...
if((array[i].years.includes("19"))&&(array[i].years.includes("18")===false)){
...
array.push({ id: 20,name:"Daniel Walker", 
    years:"1992-2021",
    genre: "Web Design", 
...
artists[8].name = "Vincent Van Dogh"
var array2=[]
for (let i=0;i < array.length; i++){if (array[i].paintings > 100){array2.push(array[i].name)}
}
return array2}
